export default {
  ...
  wiki: {
    ...
    pathConfig: {
      ...
      addTitle: '新增扫描路径',
      alias: '业务别名',
      aliasHint: '用于在文件列表中标识来源分组，建议简洁易读',
      aliasPlaceholder: '例：中基协2025处罚公告',
      path: '服务器物理路径',
      pathHint: '需为服务器可访问的绝对路径',
      pathPlaceholder: '例：/data/amac/penalties/2025/',
      fileFilter: '文件类型过滤（可选）',
      fileFilterPlaceholder: '例：*.pdf, *.txt（留空表示全部）',
      schedule: '定时自动扫描',
      scheduleOn: '开启 · 按计划自动扫描',
      scheduleOff: '关闭',
      scheduleInactive: '未生效',
      scheduleInactiveHint: '定时调度器尚未上线，当前排期仅保存不会自动触发，请手动扫描',
      removePath: '🗑 移除此路径',
      removeConfirm: '确定移除此路径配置吗？',
      removeReassignLabel: '移除后，原有文档迁移到',
      removeReassignHint: '不选择则默认迁移到"未分组文档"',
      removeFailed: '移除分组失败',
      save: '保存配置',
      saveFailed: '保存分组失败',
      addConfirm: '确认添加',
      ...
      scanFailed: '扫描失败',
      cron_hourly: '每小时',
      cron_daily02: '每日 02:00',
      cron_daily06: '每日 06:00',
      cron_daily10: '每日 10:00',
      cron_daily22: '每日 22:00',
      cron_weekly1: '每周一 02:00',
      cron_custom: '自定义 Cron 表达式',
      cronCustomPlaceholder: '例：0 0 2 * * *（秒 分 时 日 月 周）',
    },
    preview: {
      group: '分组',
      size: '大小',
      scanTime: '扫描时间',
      pages: '生成 {count} 个知识页面',
      download: '下载',
      close: '关闭',
      loading: '正在加载内容…',
      loadFailed: '内容加载失败',
    ...
    errorSection: {
      ...
      retry: '重试',
      preview: '预览',
      clearConfirm: '确定删除全部 {count} 个异常文件吗？此操作不可撤销。',
    },
    pages: 'Wiki 页面',
    config: '处理配置',
    transformations: {
