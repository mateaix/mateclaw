export default {
  ...
  skills: {
    ...
    detail: {
      ...
      uploadFiles: '上传文件',
      uploadFolder: '上传文件夹',
      uploadDestination: '保存目录',
      uploadHint: '支持 Word、Excel 等文件，文件夹会保留目录层级。单个文件不超过 10 MiB，每批最多 100 个文件、合计 50 MiB；空文件夹不会上传。',
      uploadOverwrite: '以下同名文件将被替换，是否继续？{paths}',
      uploadComplete: '已上传 {count} 个文件',
      uploadFailed: '已上传 {count} 个文件，其余未完成：{error}',
      uploadErrors: {
        batchLimit: '每批最多上传 100 个文件，合计不超过 50 MiB。',
        fileLimit: '单个文件不能超过 10 MiB。',
        invalidPath: '文件路径无效、重复或过长，请检查文件名和目录。',
      },
      fileDownload: '下载',
      binaryFileHint: '此文件保留原始格式，可下载查看；如需修改，请上传替换文件。',
      fileSaved: '文件已保存',
      fileDeleted: '文件已删除',
  ...
  skillCurator: {
    ...
    routines: '例行事项挖掘',
    routinesHint: '每晚扫描各个会话的首条请求，把你反复提出的相同请求聚成一类。同时满足「出现 {occurrences} 次」和「跨 {days} 天」两个条件才会自动合成技能——次数证明重复，跨天证明是习惯而非一个下午的反复重试。',
    noRoutines: '暂无候选',
    routineMine: '立即挖掘',
    routineMineSuccess: '挖掘完成，更新了 {n} 个候选',
    routineFilterObserving: '观察中',
    routineFilterPromoted: '已合成',
    routineFilterDismissed: '已忽略',
    routineFilterAll: '全部',
    routineStatusObserving: '观察中',
    routineStatusReady: '达标待合成',
    routineStatusPromoted: '已合成',
    routineStatusDismissed: '已忽略',
    routineOccurrences: '{n} 次',
    routineDays: '跨 {n} 天',
    routineLastSeen: '最近',
    routinePromote: '合成技能',
    routinePromoteEarly: '提前合成',
    routinePromoteEarlyConfirm: '该候选目前只出现 {occurrences} 次、跨 {days} 天，尚未达到自动合成门槛。提前合成会消耗一次 LLM 调用，并写入一个 Agent 之后每次都会参考的技能。确认继续？',
    routinePromoteSuccess: '已合成为技能',
    routineDismiss: '忽略',
