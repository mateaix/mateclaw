export default {
  ...
  agents: {
    ...
    binding: {
      ...
      wikiKicker: 'Dedicated Knowledge Base',
      wikiTagline: 'Bind a knowledge base to this agent so it can look up internal documents and references.',
      wikiHint: 'Select a knowledge base for this agent. Leave empty to skip binding.',
