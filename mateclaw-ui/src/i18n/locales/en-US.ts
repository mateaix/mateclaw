export default {
  ...
  wiki: {
    ...
    pathConfig: {
      ...
      scheduleOff: 'Off',
      scanMode: 'Scan mode',
      modeIncr: 'Incremental',
      modeIncrHint: 'Only sync new files, no reprocessing',
      modeFull: 'Full',
      modeFullHint: 'Reprocess all files in the directory',
      ...
      frontendOnlyHint: 'Config is currently stored only in this browser; backend scheduling is not wired up yet',
      cron_hourly: 'Hourly',
      ...
      cronCustomPlaceholder: 'e.g. 0 2 * * * (min hour day month weekday)',
    },
    preview: {
      group: 'Group',
      size: 'Size',
