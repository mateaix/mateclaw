export default {
  ...
  wiki: {
    ...
    sources: {
      ...
      lastScan: 'Last updated: {time}',
      noMatch: 'No matching materials',
      selectedCount: '{count} selected',
      batchReprocess: 'Batch reprocess',
    ...
    pathConfig: {
      title: 'Path config',
      titleWith: 'Path config — {name}',
      addTitle: 'Add scan path',
      alias: 'Display name',
      aliasHint: 'Used to label the source group in the file list; keep it short',
      aliasPlaceholder: 'e.g. AMAC 2025 penalties',
      path: 'Server path',
      pathHint: 'Must be an absolute path reachable by the server',
      pathPlaceholder: 'e.g. /data/amac/penalties/2025/',
      fileFilter: 'File type filter (optional)',
      fileFilterPlaceholder: 'e.g. *.pdf, *.txt (empty = all)',
      schedule: 'Scheduled auto-scan',
      scheduleOn: 'On · scans automatically on schedule',
      scheduleOff: 'Off',
      scheduleInactive: 'Not active yet',
      scheduleInactiveHint: 'The schedule is saved but the scheduler is not live yet — trigger a scan manually',
      removePath: '🗑 Remove this path',
      removeConfirm: 'Remove this path config?',
      removeReassignLabel: 'Move existing documents to',
      removeReassignHint: 'Leave unselected to move them to "Ungrouped"',
      removeFailed: 'Failed to remove group',
      save: 'Save config',
      saveFailed: 'Failed to save group',
      addConfirm: 'Add',
      addCard: 'Add a new scan path group',
      ...
      cron_hourly: 'Hourly',
      cron_daily02: 'Daily 02:00',
      cron_daily06: 'Daily 06:00',
      cron_daily10: 'Daily 10:00',
      cron_daily22: 'Daily 22:00',
      cron_weekly1: 'Mon 02:00',
      cron_custom: 'Custom cron',
      cronCustomPlaceholder: 'e.g. 0 2 * * * * (sec min hour day month weekday)',
    },
    preview: {
      group: 'Group',
      size: 'Size',
      scanTime: 'Scan time',
      pages: 'Generated {count} pages',
      download: 'Download',
      close: 'Close',
    ...
    errorSection: {
      ...
      retry: 'Retry',
      preview: 'Preview',
      clearConfirm: 'Delete all {count} error files? This cannot be undone.',
    },
    pages: 'Wiki Pages',
    config: 'Config',
    transformations: {
