export default {
  ...
  skills: {
    ...
    detail: {
      ...
      uploadHint: 'Supports Word, Excel and other files. Folder structure is preserved. Up to 10 MiB per file, 100 files and 50 MiB per batch. Empty folders are not uploaded.',
      uploadOverwrite: 'Replace these existing files? {paths}',
      uploadComplete: 'Uploaded {count} files',
      uploadFailed: 'Uploaded {count} files; remaining uploads did not finish: {error}',
      uploadErrors: {
        batchLimit: 'Each batch is limited to 100 files and 50 MiB.',
        fileLimit: 'Each file must be at most 10 MiB.',
        invalidPath: 'File paths are invalid, duplicated or too long.',
      },
      fileDownload: 'Download',
      binaryFileHint: 'This file is preserved in its original format. Download to view it, or upload a replacement to change it.',
